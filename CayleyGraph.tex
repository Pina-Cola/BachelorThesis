...
\\
\\
Bei Cayleygraphen hat man eine Gruppe, deren Elemente die Knoten des Graphens sind. Hier sind die Knoten des Graphens also die Elemente der Gruppe $(G_{2x2x2}, \circ)$ und somit alle möglichen Züge. Die Kanten entsprechen also den validen Konfigurationen des Würfels, also der Menge $C$. \\
Das erscheint mir aber anders herum sinnvoller. \textbf{TODO} \\
