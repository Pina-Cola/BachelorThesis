...
\end{figure} \ \\
Außerdem wäre das Lösen des Würfels trivial, wenn die Kommutativität gelten würde.\\
...
\\
Von dieser Konfiguration $(1,x)$ ausgehend gibt es einen Zug $M \in G_{2x2x2}$, so dass alle Eckstücke richtig ausgerichtet sind. Dann ergibt sich die Konfiguration $(1, 0)$ und alle Ecktsücke sind in der richtigen Ausrichtung und Position. Der Würfel befindet sich also in der Startkonfiguration. \\ \cite{Buch}
