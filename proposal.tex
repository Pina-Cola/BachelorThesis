...
\begin{itemize}
\item[\ref{Kapitel_Einleitung}]
\item[\ref{Kapitel_Würfel}]
\item[\ref{Kapitel_MathematischeGrundlagen}]
\item[\ref{Kapitel_KonfigurationDesWürfels}]
\item[\ref{Kapitel_WürfelAlsGruppe}]
\item[\ref{Kapitel_Untergruppen}]
\item[\ref{Kapitel_ValideKonfigurationen}]
\item[\ref{Kapitel_Lösung}]
\item[\ref{Kapitel_Fazit}]
\end{itemize}
