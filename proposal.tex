...
Die beiden beschriebenen Lösungsansätze führen nicht zu einer optimalen Lösung des Würfels. Mehr zu der optimalen Lösung findet sich am Ende von Kapitel \ref{Abschnitt_LösungBeispiel}.
...
In den Abbildungen wurde der Würfel noch um $180^\circ$ um die $z$-Achse rotiert. Der Würfel befindet sich dann in der Konfiguration $C = ((\textit{ulf} \ \textit{dlf} \ \textit{urf} \ \textit{dlb}),(2,2,0,0,2,2,1,0))$.
