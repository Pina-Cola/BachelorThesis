...
\item[\textbf{\ref{Kapitel_ValideKonfigurationen}}] Hier wird die Anzahl der möglichen Würfelkonfigurationen berechnet.
...
In Abbildung \ref{Abbildung_Cayleygraph} sieht man den Cayleygraphen der Gruppe $(\mathbb{Z}/6\mathbb{Z}, +)$ mit dem Erzeuger $1$.
...
Als Beispiel werden die Gruppe $(\mathbb{Z}/6\mathbb{Z}, +)$ und die Menge $\mathbb{Z}$ mit der Verknüpfung $-$ betrachtet. Die folgenden Eigenschaften gelten, da $(\mathbb{Z}/6\mathbb{Z}, +)$ eine Rechtsoperation auf $\mathbb{Z}$ ist, mit $z \in  \mathbb{Z}$ und $g,h \in \mathbb{Z}/6\mathbb{Z}$.
\begin{itemize}
