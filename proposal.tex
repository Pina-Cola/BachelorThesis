...
Eine symmetrische Gruppe $(S, \circ)$ ist eine Gruppe, die aus allen Permutationen (s. Abschnitt \ref{Abschnitt_PermutationZykel}) der Menge $S$ besteht. 
\end{definition}
...
Bei der symmetrischen Gruppe $(S, \circ)$ mit $S = \{(a \ b)(b \ a)(a \ c)(c \ a)(b \ c)(c \ b)\}$ enthält $S$ die Permutationen aller Elemente der $3$-elementigen Menge $\{a, b, c\}$. Somit ist die Mächtigkeit der Gruppe $3! = 1 \cdot 2 \cdot 3 = 6$. 
\end{bsp}
%
%
%
