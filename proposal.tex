...
Der 2x2x2-Würfel kann also gelöst sein, ohne dass die obere Seite weiß ist. Deshalb muss es möglich sein, den Würfel ganz zu rotieren, ohne einen Zug auszuführen. \\
...
\hline
\hline
$R_U$ & Rotation des Würfels nach oben \\
\hline
$R_D$ & Rotation des Würfels nach unten  \\
\hline
$R_R$ & Rotation des Würfels nach rechts \\
\hline
$R_L$ & Rotation des Würfels nach links\\
\hline
$R_F$ & Rotation des Würfels nach vorne\\
\hline
$R_B$ & Rotation des Würfels nach hinten\\
\hline
\end{tabular} \\
\\
Die Kürzel stehen für \textit{Up, Down, Right, Left, Front, Back}.  \\
\\
Der komplette Würfel wird gedreht. Das vorher definierte Gitter, das die Steinpositionen als Element der Menge $ \{ ulf, ulb, urb, urf, dlf, dlb, drb, drf \}$ definiert, wird hier aber nicht gedreht. Die Bezeichnung $ulf$ beispielsweise beschreibt also immernoch den Stein oben links vorne, auch wenn der Würfel rotiert wurde. \\
\\
Die Steine werden allerdings durch eine Rotation alle an einen neuen Platz gebracht. Anders als bei der Rotation der Ebenen, wo nur einige Steine diePosition ändern, ändern hier alle Steine die Position, ohne dass der Würfel verändert wird, da er komplett gedreht wird. \\
\\
Anhand des Zuges $R_R$, also einer Rotation des kompletten Würfelsnach rechts, zeige ich nun die Veränderung der Würfelkonfiguration: \\
