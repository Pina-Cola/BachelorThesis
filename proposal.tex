...
\\
\\
Wie bereits beschrieben, gilt $\forall Z \in G_{2x2x2}, n \in \mathbb{N} \ . \ Z^n=Z^{n \mod 4}$ für alle einelementigen Züge (und Rotationen), da der Würfel in seiner vorherigen Position bleibt, wenn ein Zug oder eine Rotation vier mal hintereinander ausgeführt wird.
