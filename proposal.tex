...
\\
Jede Würfelposition kann durch die Züge $U, D, F, B, L, R$ (und die Rotation des Würfels) erreicht werden. \\
Zur Erinnerung: Die Züge des Würfels sind durch folgende Zykel definiert:
\begin{align*}
\sigma_U & =\ (ulf \ ulb \ urb \ urf) \\
\sigma_D & =\ (dlf \ drf \ drb \ dlb) \\
\sigma_F & =\ (ulf \ urf \ drf \ dlf) \\
...
Die Parität eines einzelnen Zuges ist also ungerade.
