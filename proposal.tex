...
\\
\\
Für die Lösung des Würfels sind Kommutatoren oder Züge nützlich, die nur wenige Steine bewegen. So kann man dann gezielt bestimmte Steine drehen oder tauschen. \\
Ein Beispiel für einen solchen Zug ist $\lbrack R, U \rbrack \lbrack R^{-1}, F \lbrack$. Dabei werden zwei Steine der oberen Ebene gedreht. Dieser Zug kann für die Lösung der zweiten Ebene genutzt werden, ohne dabei die erste Ebene zu verändern. \\
\\
HIER DAS BILD \\
\\
Es gibt verschiedene Vorgehensweisen um den Würfel zu lösen. Üblicherweise fängt man mit der weißen Seite an, die gelbe Seite gehört dann zur letzten Ebene, die gelöst wird. \\
Eine gängige Lösungsmethode geht so vor, dass bei der letzten Ebene zuerst alle Steine richtig ausgerichtet werden. Danach werden sie erst rotiert. \\
