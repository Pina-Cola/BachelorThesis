...
ZZZZ & =Z^4=N=Z^0 \\
\end{align*}
Man kann denn Exponenten also $modulo \ 4$ rechnen, da vier Drehungen einer Ebene nacheinander wieder zum Startzustand führen. \\
Es gilt also:
$\forall Z \in G_{2x2x2}, n \in \mathbb{N} \ . \ Z^n=Z^{n \mod 4}$.
\newpage
...
Somit gilt dann auch hier $RRRR=R^4=N$ und $R^0=N$ für alle Rotationen. ($N$ ist das neutrale Element, also der leere Zug und $R$ eine beliebige Rotation des Würfels.) \\
Analog zu den Zügen gilt bei den Rotationen also für jede Rotation: $\forall R, n \in \mathbb{N} \ . \ R^n=R^{n \mod 4}$.
