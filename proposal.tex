...
$C(Z_1) \sim_{Z_r} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $Z_rZ_2$  ergeben die gleiche Würfelkonfiguration\\

\end{tabular}
\\
$Z_rZ_2$ steht für den Zug $Z_2$, der nach einer Rechtsrotation des Würfels ausgeführt wird. $C$ steht für die Würfelkonfiguration.\\
\\
Die anderen Rotationsrelationen definiere ich wie folgt: 

\begin{tabular}{l l l}

$C(Z_1) \sim_{Z_l} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $Z_lZ_2$ & ergeben die gleiche Würfelkonfiguration \\
$C(Z_1) \sim_{Y_r} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $Y_rZ_2$ & ergeben die gleiche Würfelkonfiguration\\
$C(Z_1) \sim_{Y_l} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $Y_lZ_2$ & ergeben die gleiche Würfelkonfiguration\\
$C(Z_1) \sim_{X_r} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $X_rZ_2$ & ergeben die gleiche Würfelkonfiguration\\
$C(Z_1) \sim_{X_l} C(Z_2)$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ und $X_lZ_2$ & ergeben die gleiche Würfelkonfiguration\\
...
& \Leftrightarrow \ \ \ C(Z_1)=C(WZ_2) 
& \Leftrightarrow \ \ \ Z_1=WZ_2 
\end{align*}

\item Symmetrie: \\
Für die Symmetrie muss gelten: Aus $x \sim y \ folgt \ y \sim x$. \\
Auch das gilt, da alle $\sim \in \{ \sim_{Z_r}, \sim_{Z_l}, \sim_{Y_r}, \sim_{Y_l}, \sim_{X_r}, \sim_{X_l}\}$ durch die Gleichheit definiert sind. Wenn 
