...
$Z_1 \sim_{Z_r} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das gleiche wie $Z_rZ_2$ \\
...
$Z_1 \sim_{Z_l} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das Gleiche wie $Z_lZ_2$ \\
$Z_1 \sim_{Y_r} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das Gleiche wie $Y_rZ_2$ \\
$Z_1 \sim_{Y_l} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das Gleiche wie $Y_lZ_2$ \\
$Z_1 \sim_{X_r} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das Gleiche wie $X_rZ_2$ \\
$Z_1 \sim_{X_l} Z_2$ & $:\Leftrightarrow \ \ \ \ \  Z_1$ ist das Gleiche wie $X_lZ_2$ \\
...
\\
\\
Damit $\sim_{Z_r}, \sim_{Z_l}, \sim_{Y_r}, \sim_{Y_l}, \sim_{X_r}$ und $\sim_{X_l}$ Äquivalenzrelationen sind, müssen Reflexivität, Symmetrie und Transitivität gelten, was ich im folgenden Abschnitt beweise. Ich nutze das Symbol $\sim$ für alle Elemente aus  $\{ \sim_{Z_r}, \sim_{Z_l}, \sim_{Y_r}, \sim_{Y_l}, \sim_{X_r}, \sim_{X_l}\}$.
\begin{itemize}
\item Reflexivität: \\
Es muss $x \sim x$ gelten. \\
Da alle $\sim \in \{ \sim_{Z_r}, \sim_{Z_l}, \sim_{Y_r}, \sim_{Y_l}, \sim_{X_r}, \sim_{X_l}\}$ durch die Gleichheit definiert sind, gilt $x \sim x$. (Da \glqq $x \sim x \ :\Leftrightarrow \  x$ ist das Gleiche wie $x$\grqq \ (also $x \sim x \ :\Leftrightarrow x=x$) laut Definition gilt.)
\item Symmetrie
\item Transitivität
\end{itemize}
