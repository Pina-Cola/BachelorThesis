...
\\
\textcolor{gray}{Lösungsidee: \\
Die Bedingungen würden wieder gelten, wenn man zwei Äquivalenzoperatoren verschachtelt und somit vor beiden Zügen den Würfel rotiert. \\
Man müsste dann in der Definition der Äquivalenzrelationen die anderen Äquivalenzrelationen der Rotationen bereits nutzen. \\
Das scheint mir mathematisch aber nicht korrekt. (?) }
...
Diese Ansatz dieser Äquivalenzrelationen funktioniert so nicht, da die Reflexivität, Symmetrie und Transitivität nicht erfüült sind.
