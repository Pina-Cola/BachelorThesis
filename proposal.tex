...
Bei dem \Tthree Würfel ist die Parität jeder Permutation gerade, deshalb gibt es keinen Zug, der genau zwei Steine im Würfel tauscht \cite{TD}. Im Gegensatz dazu kann die Parität der Zykel des \Ttwo Würfels ungerade sein und es gibt für diesen Würfel Algorithmen, die die Position von genau zwei Steinen tauschen. Diese Algorithmen sind in Kapitel \ref{Abschnitt_AlgorithmenZweiteEbene} beschrieben. 
