...
\\
Anhand der Rotation $R_{Z_r}$, also einer Rotation des kompletten Würfels um die $z$-Achse um $90^\circ$ im Uhrzeigersinn, zeige ich nun die Veränderung der Würfelpositionen. 
\begin{figure}[H]
\centering
...
\\
\subsection*{Äquivalenzklassen der Rotationen}\addcontentsline{toc}{subsection}{\protect\numberline{}Äquivalenzklassen der Rotationen}
