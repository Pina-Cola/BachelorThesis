...
\begin{description}
\item [$C \cdot N = x$ für alle $C \in M_C$ und das neutrale Element $N \in \Gtwo$] 
\ \\
Wenn der leeren Zug $N$ ausgeführt wird, wird die Konfiguration des Würfels nicht verändert. Es gilt also $C \cdot N = C$. 

\item [$C \cdot (Z_1 \circ Z_2) = (c \cdot Z_1) \cdot Z_2$ für alle $Z_1, Z_2 \in \Gtwo$ und $c \in M_C$]
\ \\
