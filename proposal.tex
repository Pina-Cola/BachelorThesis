...
Anhand des Beispielzuges $R$ kann eine Funktion $f_R$ aufgestellt werden, die die Veränderung des Vektors $x$ nach Ausführen des Zuges $R$ bei jeder beliebigen Ausgangskonfiguration beschreibt. Da $x_1, x_3, x_5$ und $x_7$ nicht beeinfluss werden, bleiben diese unverändert.
\begin{align*}
f_R(x_1)=x_1 \ \ \ \ \ f_R(x_3)=x_3 \ \ \ \ \ f_R(x_5)=x_5 \ \ \ \ \ f_R(x_7)=x_7 
\end{align*}
