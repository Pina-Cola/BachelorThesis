...
\\
Bei der Grundposition (auch Startkonfiguration) des 2x2x2 Würfels hat jede Seite 4 Farbflächen einer Farbe. Der Würfel ist dann gelöst. \\
...
\end{itemize}
Also kann die Konfiguration des Würfels als ein 3-Tupel geschrieben werden: $(\sigma), x$
...
\end{figure}
\ \\
Wenn $x=(0, 0, 0, 0, 0, 0, 0, 0)$ schreibe ich es kurz als $x=0$.
...
\\
Wenn wir den leeren Zug $N$ ausführen, wird die Konfiguration des Würfels nicht verändert. Es gilt also $C \cdot = C$. \\
\\
