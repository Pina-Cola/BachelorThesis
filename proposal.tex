...
Es gilt aber auch $\mathbb{Z}/6\mathbb{Z} \subseteq \mathbb{Z}$. Da sowohl $(\mathbb{Z},+)$, als auch $(\mathbb{Z}/6\mathbb{Z}, +)$ Gruppen sind, ist $(\mathbb{Z}/6\mathbb{Z}, +)$ eine Untergruppe von $(\mathbb{Z},+)$.
...
Für die Menge $A=\{ 1, 2, 3, 4, 5 \}$ werden nun die Relationen $<$ und $=$ betrachtet:
\begin{itemize}
\item $ x < y$
...
Bei der Relation $=$ gilt die Reflexivität für alle Elemente, da die Gleichheit reflexiv ist. Auch die Symmetrie und die Transitivität gelten für die Gleichheit. 
\end{itemize}
...
\midrule
\includegraphics[scale=0.1]{TOPVIEW1.png} & $F \ [ R,U ] \  [ R,U ] \  [ R,U ] \ F^{-1}$ \\
\includegraphics[scale=0.1]{TOPVIEW2.png} & $F \ [ R,U ] \  [ R,U ] \ F^{-1}$ \\
\bottomrule
\end{tabular}
\end{center}
...
Ausgangsposition & Algorithmus  \\
\midrule
\includegraphics[scale=0.1]{TOPVIEW3_1.png} & $R \ U \ R^{-1} \ U \ R \ UU \ R^{-1}$ \\
\includegraphics[scale=0.1]{TOPVIEW3_2.png} & $L^{-1} \ U^{-1} L \ U^{-1} \ L^{-1} \ UU \ L$ \\
\includegraphics[scale=0.1]{TOPVIEW4.png} & $F \ [ R,U ] \ F^{-1}$ \\
\includegraphics[scale=0.1]{TOPVIEW5.png} & $[ R,U ] \ [R^{-1}, F]$ \\
\includegraphics[scale=0.1]{TOPVIEW6.png} & $F \ [ R,U ]\ R^{-1} \ F^{-1}\ R$ \\
\bottomrule
\end{tabular}
\end{center}

Die obere Seite des Würfels zeigt nach den Algorithmen nur noch gelbe Farbflächen. Die Ausrichtung der Steine ist also bereits richtig. Danach werden die Steine getauscht, bis sie richtig angeordnet sind.
