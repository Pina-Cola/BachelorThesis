...
Die Menge der minimalen Züge ist $\{ U, R, F\}$. Die Permutationen dieser drei Grundzüge sind die Permutationen $\sigma$. Dabei handelt es sich um die gleichen Permutationsfunktionen wie in Kapitel \ref{Abschnitt_PositionenDerSteineImWürfel}. Es gibt aber nur drei statt sechs Funktionen.
...
In diesem Abschnitt wird bewiesen, dass die Mengen $\Gtwo$ und $G_{min}$ gleichnächtig sind und somit beide eine vollständige Abbildung des \Ttwo Würfels bilden. 
