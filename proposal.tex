...
Es wir die Definition einer Gruppe (auch anhand von Beispielen) und die der Untergruppen erklärt. Dazu werden auch Erzeuger (die Untergruppen erzeugen) definiert. Außerdem wird die Zykelschreibweise eingeführt und erklärt.
...
Sei $M \subseteq G$ eine nicht leere Teilmenge einer Gruppe $(G, \circ)$, dann ist die Untergruppe $\langle M \rangle$ von $M$ erzeugt und ist die kleinste Untergruppe von $G$, die $M$ enthält.
