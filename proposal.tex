...
Eine gängige Lösungsmethode für die zweite Ebene geht so vor, dass zuerst alle Steine der Ebene richtig ausgerichtet werden. Dann sind alle $x_i=0$. Außerdem wird der Würfel dafür üblicherweise gedreht, damit die gelbe Seite oben ist. Danach werden die Positionen noch getauscht. Die Würfelkonfiguration ist dann $(1,0)$.
