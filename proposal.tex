...
\\
Ausrichtung der Steine definieren \\
...
\sigma_D & =\ (dlf \ drf \ dlb \ drb) \\
\sigma_F & =\ (ulf \ urf \ dlf \ drf) \\
\sigma_B & =\ (ulb \ urb \ dlb \ drb) \\
\sigma_L & =\ (ulb \ ulf \ dlf \ dlb) \\
\sigma_R & =\ (urb \ urf \ drf \ drb) \\
\end{align*}

\newpage

\subsection*{Konfiguration des Würfels}
Die Konfiguration des Würfels, also die Position/Verdrehung des Würfels setzt sich aus drei Parametern zusammen: \\
\begin{itemize}
\item Position der Ecksteine (angegeben durch \textit{ulf, ulb, urb, urf, dlf, drf, dlb, drb})
\item Ausrichtung der Ecksteine
\item (Ausrichtung des Würfels) (\textbf{TODO})
\end{itemize}
