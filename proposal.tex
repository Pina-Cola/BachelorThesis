...
\end{align*}
Bei den Rotationen wird (analog zu den Zügen) die mehrfache Ausführung einer Rotation mit der Exponentenschreibweise geschrieben. 
...
Wie bereits beschrieben, gilt $\forall Z \in \{ U, D, F, B, L, R \}. n \in \mathbb{N} \ . \ Z^n=Z^{n \mod 4}$, da alle Steine des Würfels in ihrer vorherigen Position bleiben, wenn eine Ebenen- oder eine Würfelrotation vier mal hintereinander ausgeführt wird. Dann werden die Züge $U, D, F, B, L, R$ als Permutationen der Ordnung 4 bezeichnet. 
