...
\end{align*}
Der Würfel kann nur durch einen der Grundzüge des Würfels oder einer Kombination der Grundzüge verändert werden. Die Veränderungen des Vektors $x$ durch die Funktion $\gamma$ sind in der folgenden Tabelle detailliert zu sehen.

\begin{adjustbox}{width=1\textwidth,center}
\begin{tabular}{c l c c }
\toprule
\textbf{Zug} $\boldsymbol{Z}$ & Vektor $x$ & \textbf{Veränderung} $\boldsymbol{x}$ & $\boldsymbol{\mod 3}$ \\
\midrule
$U$ & $(x_3, x_1,x_4,x_2,x_5,x_6,x_7,x_8)$ & 0 & 0 \\

% $D$ & $x_1$ & $x_2$ & $x_3$ & $x_4$ & $x_6$ & $x_8$ & $x_5$ & $x_7$ & 0 & 0 \\

%$R$ & $x_1$ & $(x_4 + 1) \vspace*{-0.5em} \mod 3$ & $x_3$ & $(x_8 + 1) \vspace*{-0.5em} \mod 3$ & $x_5$ & $(x_2 +1) \vspace*{-0.5em} \mod 3$ & $x_7$ & $(x_6 + 2) \vspace*{-0.5em} \mod 3$ & 0 & 0 \\
