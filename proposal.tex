...
\end{align*}
Da die Rotationen zu den Zügen zählen, wird die mehrfache Ausführung einer Rotation auch mit der Exponentenschreibweise geschrieben. 
Somit gilt für jede Rotation $TTTT=T^4=N_R$ (für $T \in \{{Z_r}, {Z_l}, {Y_r}, {Y_l}, {X_r}, {X_l} , N_R \}$) und $T^0=N_R$ (für alle Rotationen $T$). Dabei ist $N_R$ die leere Rotation und $T$ ist eine beliebige Rotation des Würfels. 
